...
const SettingLayout: FC<SettingLayoutProps> = ({
  ...
  <div className="flex justify-between items-center p-5 bg-white dark:bg-primary-dark rounded-2xl shadow-xs hover:shadow-lg hover:scale-[1.01] transition-all border border-gray-100 dark:border-white w-full">
